//
//  EditionDetailTableViewController.swift
//  devils-advocate
//
...
class EditionDetailTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    let searchController = UISearchController(searchResultsController: nil)
        ...
        override func viewDidLoad() {
            self.title = selectedEdition?.title
            getArticles()
        ...
        func getArticles() {
            Database.database().reference().child("articles").queryOrdered(byChild: "edition").queryEqual(toValue:selectedEdition?.id).observeSingleEvent(of: .value, with: { (snapshot) in
    ...
    //        return authorResult!
        ...
        override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "editionArticleCell", for: indexPath)
    ...
    //        }
        ...
        override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            performSegue(withIdentifier: "EditionDetailTableViewtoArticleDetail", sender: article)
        }
